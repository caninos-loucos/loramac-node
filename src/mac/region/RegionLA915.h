 ...
 */
#define LA915_PING_SLOT_CHANNEL_FREQ                923300000
 ...
 */
#define LA915_BAND0                                 { 1, LA915_MAX_TX_POWER, 0, 0, 0, 0, 0 } //  100.0 %
 ...
 */
static const uint8_t MaxPayloadOfDatarateDwell0LA915[] = { 51, 51, 51, 115, 242, 242, 242, 0, 53, 129, 242, 242, 242, 242 };

/*!
 * Maximum payload with respect to the datarate index.
 * The table is valid for the dwell time configuration of 1 for uplinks.
 */
static const uint8_t MaxPayloadOfDatarateDwell1LA915[] = { 0, 0, 11, 53, 125, 242, 242, 0, 53, 129, 242, 242, 242, 242 };
